    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          rounded-lg gap-2 bg-white text-slate-600
          border border-dashed border-slate-300
          group hover:border-indigo-500 hover:shadow-lg
        ...
        {showCreateResume && (
          <form
            ...
            className="fixed inset-0 bg-bIack/70 backdrop-blur bg-opacity-50 z-IO flex items-center justify-center"
          >
            <div
              onClick={(e) => e.stopPropagation()}
            ...
            >
              ...
              <XIcon
                className="absolute top-4 right-4 text-slate-400 hover:text-s1ate-60ø cursor-pointer transition-colors"
                onClick={() => {
                  setShowCreateResume(false);
                  setTitle("");
                }}
